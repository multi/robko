...
githubMiddleware = (() ->
  if process.env.HUBOT_GITHUB_WEBHOOK_SECRET
    return require('github-webhook-middleware')({
...
module.exports = (robot) ->
  robot.router.post "/#{robot.name}/gh-pull-requests", githubMiddleware, (req, res) ->
